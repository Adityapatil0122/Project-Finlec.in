...
const benefits = [
  "Create SIP plans tailored to your life goals",
  "Get expert-backed fund recommendations",
  "Track, manage, and optimize your portfolio in one place",
];
        ...
        <div className="grid lg:grid-cols-2">
          <div className="bg-gradient-to-br from-[#04b488] via-[#00b286] to-[#7B4FD4] p-8 text-white sm:p-10">
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-green-50 sm:text-base">
              Start building long-term wealth with SIP planning, trusted funds,
              and powerful portfolio insights in one place.
            </p>
