...
export default function DailySIPCalculatorPage() {
  return (
    <MarketingShell>
      {/* HERO SECTION */}
      <section className="relative overflow-hidden bg-[#f8f9fa] px-4 pb-24 pt-10 sm:px-6 lg:px-8">
        <div className="pointer-events-none absolute -left-32 top-10 h-72 w-72 rounded-full bg-[#0ea5e9]/12 blur-3xl" />
        <div className="pointer-events-none absolute right-[-120px] top-32 h-64 w-64 rounded-full bg-[#7B4FD4]/14 blur-3xl" />

        <div className="relative mx-auto max-w-7xl">
          <div className="mb-8 flex flex-wrap items-center gap-2 text-sm text-[#4a5568]">
            ...
            <ChevronRight size={14} />
            <span className="font-semibold text-[#1a1560]">Daily SIP Guide</span>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg text-[#4a5568]">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {jumpLinks.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="inline-flex items-center rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-600 shadow-sm transition-colors hover:border-[#0ea5e9]/40 hover:text-[#0ea5e9]"
                  >
                    {link.label}
                  </Link>
                ))}
            ...
            <div className="relative mx-auto w-full max-w-md lg:max-w-full">
              <div className="relative aspect-square overflow-hidden rounded-[2.5rem] bg-gradient-to-tr from-[#0ea5e9]/20 to-[#7B4FD4]/20 p-1.5 shadow-2xl backdrop-blur-md">
                <div className="absolute inset-0 bg-white/40 rounded-[2.5rem]" />
                <Image
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="mt-10 space-y-8">
                <div className="group flex gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#1a1560]">Rupee Cost Averaging on Steroids</h3>
                ...
                <div className="group flex gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#1a1560]">Zero Market Timing Anxiety</h3>
                    <p className="mt-2 text-md leading-relaxed text-[#4a5568]">
      ...
      {/* 02. PIGMY DEPOSIT */}
      <section id="pigmy-deposit" className="bg-[#f8fafc] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="order-1 flex items-start gap-6 lg:order-2">
            <span className="text-7xl font-bold text-slate-200">02</span>
            <div className="pt-2">
              <div className="flex items-center gap-3">
      ...
      <section id="face-off" className="bg-[#f8fafc] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-4xl font-bold text-[#1a1560] font-[family-name:var(--font-sora)] sm:text-5xl">
          ...
          <div className="mt-16 grid gap-6 lg:grid-cols-2">
            ...
            {/* Contender 1: Pigmy */}
            <div className="group relative rounded-[2.5rem] border border-slate-200 bg-white p-8 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-300">
              <div className="mb-6 flex items-center justify-between">
                <span className="text-4xl font-black text-slate-100">LVL 1</span>
                <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-bold text-slate-500">TRADITIONAL</span>
              </div>
              <h3 className="text-2xl font-bold text-[#1a1560]">Pigmy Deposit</h3>
              <p className="mt-2 text-sm text-[#4a5568]">The reliable old-school piggy bank.</p>

              <div className="mt-8 space-y-5">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-500"><Coins size={20} /></div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Wealth Power</p>
                    <p className="font-bold text-[#1a1560]">Very Low (3-5%)</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-500"><Lock size={20} /></div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Liquidity</p>
                    <p className="font-bold text-[#1a1560]">Locked</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-500"><Zap size={20} /></div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Inflation </p>
                    <p className="font-bold text-[#1a1560]">Negative</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-500"><Clock size={20} /></div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Investment type</p>
                    <p className="font-bold text-[#1a1560]">Manual</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-500"><HandCoins size={20} /></div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Hidden Debuffs</p>
                    <p className="font-bold text-[#1a1560]">Agent Fees (2-3%)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-[2.5rem] border-2 border-[#0ea5e9] bg-white p-8 shadow-xl shadow-[#0ea5e9]/20 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#0ea5e9]/40">
              <div className="absolute -right-10 -top-10 opacity-[0.03] transition-transform duration-500 group-hover:scale-110 group-hover:opacity-10"><Trophy size={200} className="text-[#0ea5e9]" /></div>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-[#1a1560]">Daily SIP (Eq. Mutual Funds)</h3>
                <p className="mt-2 text-sm text-[#4a5568]">The modern wealth creation engine.</p>
                ...
                <div className="mt-8 space-y-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-[#1a1560]">Extremely High (10-15%+)</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-[#1a1560]">High (Exit anytime*)</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#0ea5e9]/10 text-[#0ea5e9]"><Zap size={20} /></div>
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-[#0ea5e9]">Inflation</p>
                      <p className="font-bold text-[#1a1560]">Strong (Beats Inflation)</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#0ea5e9]/10 text-[#0ea5e9]"><Clock size={20} /></div>
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-[#0ea5e9]">Investment type</p>
                      <p className="font-bold text-[#1a1560]">Auto</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-[#1a1560]">Rupee Cost Averaging</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* MUTUAL FUND LANES */}
      <section id="fund-lanes" className="bg-[#f8f9fa] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between text-center md:text-left">
            ...
            <p className="max-w-xl text-lg text-[#4a5568] mx-auto md:mx-0">
              Align your Daily SIPs with the right funds. Equity for growth, Hybrid for balance, Debt for stability.
            </p>
          </div>

          <div className="mt-16 grid gap-8 md:grid-cols-3">
            <div id="equity-funds" className="group rounded-3xl border border-slate-200 bg-white p-8 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#04b488]/10">
              ...
              <h3 className="mt-6 text-2xl font-bold text-[#1a1560] font-[family-name:var(--font-sora)]">
                Equity Funds
              </h3>
            ...
            <div id="hybrid-funds" className="group rounded-3xl border border-slate-200 bg-white p-8 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#7B4FD4]/10">
            ...
            <div id="debt-funds" className="group rounded-3xl border border-slate-200 bg-white p-8 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-300">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#0f172a]/10 text-[#0f172a] transition-colors group-hover:bg-[#0f172a] group-hover:text-white">
                <ShieldCheck size={28} />
              </div>
              <h3 className="mt-6 text-2xl font-bold text-[#1a1560] font-[family-name:var(--font-sora)]">
                Debt Funds
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center text-sm font-bold text-[#0f172a] transition-colors hover:text-[#04b488]"
              >
                Explore Debt Funds
                <ChevronRight size={18} className="ml-1" />
              </Link>
      ...
      <section id="faqs" className="bg-white px-4 py-24 sm:px-6 lg:px-8 border-y border-slate-200">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 divide-y divide-slate-200 rounded-2xl border border-slate-200 bg-white/80 shadow-sm backdrop-blur">
            {[
              {
              ...
              <details key={faq.q} className="group px-6 py-5">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-6 text-left text-base font-semibold text-[#1a1560] [&::-webkit-details-marker]:hidden">
                  <span>{faq.q}</span>
