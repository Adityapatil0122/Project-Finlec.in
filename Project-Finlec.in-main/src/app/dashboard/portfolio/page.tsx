    ...
    <div className="space-y-6">
      <section className="grid gap-4 md:grid-cols-3">
        <MetricCard
          ...
          hint="Live positions synced against folio-linked orders."
          tone="green"
        />
        <MetricCard
          label="Folios"
          value={`${platform.folios.length}`}
          hint="Distributor and RTA references attached to each investment account."
          tone="violet"
        />
        <MetricCard
          label="Portfolio XIRR"
          value={formatPercent(platform.overview.xirr)}
          hint="Annualized return estimate based on current holding set."
          tone="blue"
        />
      </section>
