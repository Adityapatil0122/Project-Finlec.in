...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#f3f4f6] px-3 py-6 sm:px-4 sm:py-10">
      <div className="w-full max-w-5xl overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="grid lg:grid-cols-2">
          ...
          <div className="p-5 sm:p-10">
            <h2 className="text-2xl font-bold text-[#1a1560] sm:text-3xl">Create Your Account</h2>
