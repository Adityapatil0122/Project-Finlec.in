...
export default function DailySIPCalculatorPage() {
  return (
    <MarketingShell>
      {/* HERO SECTION */}
      <section className="relative overflow-hidden bg-[#f8f9fa] px-4 pb-24 pt-28 sm:px-6 lg:px-8">
      ...
      <section id="why-daily-sip" className="bg-white px-4 py-24 sm:px-6 lg:px-8 border-y border-slate-200">
      ...
      <section id="daily-sip" className="bg-[#f8f9fa] px-4 py-24 sm:px-6 lg:px-8">
              ...
              <div className="mt-8 space-y-5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#1a1560]">High (Agent Meetings)</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                ...
                <div className="mt-8 space-y-5">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-[#1a1560]">Zero (Fully Automated)</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
