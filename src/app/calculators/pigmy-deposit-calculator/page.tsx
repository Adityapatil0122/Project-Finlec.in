...
export default function PigmyDepositCalculatorPage() {
  return (
    <MarketingShell>
      <section className="relative overflow-hidden bg-[#f8f9fa] px-4 pb-28 pt-28 dark:bg-transparent sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="mb-8 flex items-center gap-2 text-sm text-[#4a5568] dark:text-slate-400">
            ...
            <ChevronRight size={14} />
            <span className="font-semibold text-[#1a1560] dark:text-white">Pigmy Deposit Guide</span>
          </div>
          ...
          >
            <motion.div variants={fadeItem}>
              ...
              <p className="mt-4 max-w-2xl text-lg text-[#4a5568] dark:text-slate-300">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 transition-colors hover:border-[#f97316]/40 hover:text-[#f97316] dark:border-white/10 dark:bg-slate-950/60 dark:text-slate-200 dark:hover:border-[#f97316]/50"
                >
                  Daily SIP Guide
                </Link>
              </div>
              <div className="mt-4 flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
                ...
                <Link
                  ...
                  className="rounded-full border border-slate-200 px-3 py-1 text-[11px] text-slate-500 transition-colors hover:border-[#f97316]/40 hover:text-[#f97316] dark:border-white/10 dark:text-slate-300"
                >
                  XIRR
                </Link>
                <Link
            ...
            <motion.div variants={fadeItem} className="space-y-6">
              <div className="border-l-2 border-[#f97316] pl-4">
                ...
                <p className="mt-2 text-sm text-[#4a5568] dark:text-slate-300">
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeItem} className="flex items-start gap-5">
            <span className="text-5xl font-semibold text-slate-200 dark:text-slate-800">01</span>
            <div>
          ...
          <motion.div variants={fadeItem} className="space-y-4 text-sm text-[#4a5568] dark:text-slate-300">
            <div className="flex items-start gap-4 border-b border-slate-200 pb-4 dark:border-white/10">
        ...
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-xl text-sm text-[#4a5568] dark:text-slate-300">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={item.title} className="border-t border-slate-200 pt-4 dark:border-white/10">
                <p className="text-sm font-semibold text-[#1a1560] dark:text-white">{item.title}</p>
                <p className="mt-2 text-sm text-[#4a5568] dark:text-slate-300">{item.detail}</p>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div {...fadeUp} className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="border-t border-slate-200 pt-4 dark:border-white/10">
              <p className="text-sm font-semibold text-[#1a1560] dark:text-white">Collection fee</p>
              <p className="mt-2 text-sm text-[#4a5568] dark:text-slate-300">
                Ask if the agent charges per visit or per month, and how it affects returns.
              </p>
            </div>
            <div className="border-t border-slate-200 pt-4 dark:border-white/10">
              <p className="text-sm font-semibold text-[#1a1560] dark:text-white">Deposit frequency</p>
              <p className="mt-2 text-sm text-[#4a5568] dark:text-slate-300">
                Daily collections add convenience but can reduce net yield vs monthly deposits.
              </p>
            </div>
            <div className="border-t border-slate-200 pt-4 dark:border-white/10">
              <p className="text-sm font-semibold text-[#1a1560] dark:text-white">Maturity options</p>
              <p className="mt-2 text-sm text-[#4a5568] dark:text-slate-300">
          ...
          <div className="mt-10 border-y border-slate-200 py-6 text-sm text-[#4a5568] dark:border-white/10 dark:text-slate-300">
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-[1.2fr_1fr_1fr]">
              <span className="text-sm font-semibold text-[#1a1560] dark:text-white">Daily cash saving</span>
              <span>Best fit</span>
              <span>Requires bank debit</span>
            </div>
            <div className="mt-3 grid gap-3 md:grid-cols-[1.2fr_1fr_1fr]">
              <span className="text-sm font-semibold text-[#1a1560] dark:text-white">Stable returns</span>
              <span>Lower</span>
              <span>Market linked</span>
            </div>
            <div className="mt-3 grid gap-3 md:grid-cols-[1.2fr_1fr_1fr]">
              <span className="text-sm font-semibold text-[#1a1560] dark:text-white">Long-term growth</span>
              <span>Limited</span>
        ...
        <motion.div {...fadeUp} className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid gap-10 md:grid-cols-3">
            ...
            <div className="border-t-2 border-[#0f172a] pt-6">
              <div className="flex items-center gap-3">
                <ShieldCheck size={18} className="text-[#0f172a] dark:text-white" />
                <h3 className="text-2xl font-semibold text-[#1a1560] font-[family-name:var(--font-sora)] dark:text-white">
                  Debt Funds
                </h3>
              </div>
              ...
              <Link
                ...
                className="mt-4 inline-flex items-center text-sm font-semibold text-[#0f172a] transition-colors hover:text-[#04b488] dark:text-slate-200 dark:hover:text-[#7ff7cc]"
              >
                Explore Debt
                <ChevronRight size={16} />
              </Link>
      ...
      <section className="bg-white px-4 py-20 dark:bg-[#0b0f1a] sm:px-6 lg:px-8">
        <motion.div {...fadeUp} className="mx-auto max-w-6xl">
          <div className="flex flex-col items-start gap-4 text-left md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-lg text-sm text-[#4a5568] dark:text-slate-300">
              A quick health check on Finlec adoption and client outcomes.
            </p>
          </div>

          <div className="mt-10 grid gap-6 border-y border-slate-200 py-10 dark:border-white/10 md:grid-cols-4">
            <div className="space-y-2">
              <p className="text-4xl font-semibold text-[#1a1560] dark:text-white">500Cr+</p>
              <p className="text-sm font-semibold text-[#04b488]">Assets Guided</p>
              <p className="text-xs text-[#4a5568] dark:text-slate-400">Client capital under advisory</p>
            </div>
            <div className="space-y-2 md:border-l md:border-slate-200 md:pl-6 dark:md:border-white/10">
              <p className="text-4xl font-semibold text-[#1a1560] dark:text-white">1200+</p>
              <p className="text-sm font-semibold text-[#04b488]">Active SIP Mandates</p>
              <p className="text-xs text-[#4a5568] dark:text-slate-400">Disciplined monthly contributions</p>
            </div>
            <div className="space-y-2 md:border-l md:border-slate-200 md:pl-6 dark:md:border-white/10">
              <p className="text-4xl font-semibold text-[#1a1560] dark:text-white">40+</p>
              <p className="text-sm font-semibold text-[#04b488]">Partner AMCs</p>
              <p className="text-xs text-[#4a5568] dark:text-slate-400">Top fund houses integrated</p>
            </div>
            <div className="space-y-2 md:border-l md:border-slate-200 md:pl-6 dark:md:border-white/10">
              <p className="text-4xl font-semibold text-[#1a1560] dark:text-white">93%</p>
              <p className="text-sm font-semibold text-[#04b488]">Goal Success Rate</p>
              <p className="text-xs text-[#4a5568] dark:text-slate-400">Clients on target trajectory</p>
            </div>
          </div>
        </motion.div>
      </section>
