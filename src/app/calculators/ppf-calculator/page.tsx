      ...
      <section className="relative overflow-hidden bg-[#f8f9fa] px-4 pb-28 pt-10 sm:px-6 lg:px-8">
         ...
         <div className="relative mx-auto max-w-6xl">
           <div className="mb-6 flex items-center gap-2 text-sm text-[#4a5568]">
             ...
             <ChevronRight size={14} />
             <span className="font-semibold text-[#1a1560]">PPF Calculator</span>
           </div>
           ...
           <div className="mt-20 rounded-[32px] border border-slate-200 bg-white/50 p-6 sm:p-10">
              <h2 className="text-2xl font-semibold text-[#1a1560] mb-4">What is a PPF Calculator?</h2>
              <div className="space-y-4 text-[#4a5568] leading-relaxed">
                 ...
                 <p>
                    A PPF calculator helps you estimate the long-term growth of your PPF investments over the mandatory 15-year lock-in period. Since the maximum investment allowed under Section 80C is ₹1.5 Lakhs per year, our calculator keeps the inputs within that limit so your estimates stay realistic and tax-compliant.
                 </p>
              </div>
           </div>
         </div>
