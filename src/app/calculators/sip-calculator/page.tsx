      ...
      <section className="relative overflow-hidden bg-[#f8f9fa] px-4 pb-28 pt-24 sm:px-6 lg:px-8">
         ...
         <div className="relative mx-auto max-w-6xl">
           <div className="mb-6 flex items-center gap-2 text-sm text-[#4a5568]">
             ...
             <ChevronRight size={14} />
             <span className="font-semibold text-[#1a1560]">SIP Calculator</span>
           </div>
           ...
           <div className="mt-20 rounded-[32px] border border-slate-200 bg-white/50 p-6 sm:p-10">
              <h2 className="text-2xl font-semibold text-[#1a1560] mb-4">What is a SIP Calculator?</h2>
              ...
              <h2 className="text-2xl font-semibold text-[#1a1560] mt-8 mb-4">How can a SIP return calculator help you?</h2>
