      ...
      <section className="relative overflow-hidden bg-[#f8f9fa] px-4 pb-28 pt-24 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="mb-6 flex items-center gap-2 text-sm text-[#4a5568]">
            ...
            <ChevronRight size={14} />
            <span className="font-semibold text-[#1a1560]">XIRR Calculator</span>
          </div>
          ...
          <div className="mt-20 grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <h2 className="text-2xl font-semibold text-[#1a1560]">What is XIRR?</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#1a1560]">When should you use it?</h2>
              <ul className="mt-4 list-disc pl-5 text-sm leading-relaxed text-[#4a5568]">
