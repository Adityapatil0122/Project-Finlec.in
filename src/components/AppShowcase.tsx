      ...
      <div className="mx-auto max-w-7xl space-y-10">
        ...
        >
          <motion.div variants={mobileFadeUp}>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-[#475569]">
              Plan major family goals, see how much you need, and track your
              progress without the usual confusion.
            </p>
            <Link
            ...
            <PhoneShell tiltClassName="lg:-rotate-1">
              ...
              <div className="mt-5 space-y-3">
                <div className="rounded-2xl border border-white/15 bg-white/[0.14] p-3 shadow-[0_10px_25px_-18px_rgba(255,255,255,0.45)]">
                  ...
                  <p className="mt-2 text-xs text-white/85">Child&apos;s Education 2036</p>
              ...
              <div className="mt-auto rounded-2xl bg-white p-4 text-[#1a1560] shadow-lg shadow-black/20">
                <p className="text-xs font-semibold">Suggested SIP</p>
                <button
                  type="button"
        ...
        >
          <motion.div variants={mobileFadeUp}>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-[#475569]">
              Finlec helps investors build wealth with consistent SIPs and a
              long-term plan they can actually stick to.
            </p>
            <Link
              href="https://finlec.my-portfolio.co.in/app/#/login"
              className="mt-6 inline-block rounded-full border border-[#04b488]/20 bg-[#04b488]/10 px-6 py-2.5 text-sm font-semibold text-[#04b488] transition-colors hover:bg-[#04b488]/15"
            ...
            <Testimonial
              quote="I crossed my first ₹10 lakh in mutual funds with Finlec. The platform is simple and easy to follow."
              initials="SP"
