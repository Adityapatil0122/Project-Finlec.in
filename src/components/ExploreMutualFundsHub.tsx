  ...
  return (
    <div className="relative overflow-hidden pt-20">
      <section className="relative px-4 pb-8 pt-10 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[36px] border border-white/75 bg-white/84 p-6 shadow-[0_28px_80px_-46px_rgba(14,23,40,0.48)] backdrop-blur-xl sm:p-8">
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(4,180,136,0.05),rgba(123,79,212,0.06))]" />

          <div className="relative grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-end">
            <div>
              <p className="inline-flex items-center rounded-full border border-[#04b488]/20 bg-[linear-gradient(90deg,rgba(4,180,136,0.12),rgba(123,79,212,0.08))] px-4 py-2 text-sm font-semibold text-[#00a57d]">
                Fund Discovery Hub
              </p>
              ...
              <p className="mt-4 max-w-2xl text-base leading-relaxed text-[#4a5568] sm:text-lg">
            ...
            <div className="rounded-[30px] border border-slate-200/80 bg-white/72 p-5 backdrop-blur-sm">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#7B4FD4]">
                {assetSpotlights[activeAsset].eyebrow}
              </p>
              <p className="mt-3 text-lg font-semibold text-[#1a1560] font-[family-name:var(--font-sora)]">
              ...
              <div className="mt-5 rounded-2xl border border-[#04b488]/18 bg-[linear-gradient(135deg,rgba(4,180,136,0.08),rgba(123,79,212,0.08))] px-4 py-3">
              ...
              return (
                <button
                  ...
                  className={`rounded-[28px] border p-5 text-left transition-all ${isActive
                      ? "border-[#04b488]/28 bg-[linear-gradient(135deg,rgba(4,180,136,0.12),rgba(123,79,212,0.08))] shadow-[0_20px_40px_-32px_rgba(4,180,136,0.7)]"
                      : "border-slate-200 bg-white/80 hover:border-[#04b488]/25"
                    }`}
                >
                  <div className="flex items-start gap-4">
                    <span className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#04b488]/12 text-[#04b488]">
                      <Icon size={22} />
                    </span>
                    <div>
                      <p className="text-xl font-semibold text-[#1a1560] font-[family-name:var(--font-sora)]">
                        {category.title}
                      </p>
      ...
      <section className="px-4 pb-16 pt-2 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-[34px] border border-slate-200 bg-white/84 p-6 shadow-[0_24px_70px_-46px_rgba(15,23,42,0.45)] backdrop-blur-xl sm:p-8">
          ...
          <div className="mt-8 text-center">
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 text-lg font-semibold text-[#00a761] transition-colors hover:text-[#008d52]"
            >
