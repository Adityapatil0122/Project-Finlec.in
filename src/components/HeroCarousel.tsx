...
const slides: SlideData[] = [
  {
    id: 1,
    title: "Mutual Funds KYC",
    highlight: "Aasaan Hai",
    subtitle: "For steps to check your KYC status click below",
    image: "/images/relaxedthinking.webp",
    ctaText: "Know More",
    ctaLink: "#",
    accent: "#0b795c",
    surface:
      "linear-gradient(135deg, rgba(11,121,92,0.12) 0%, rgba(255,255,255,0.96) 48%, rgba(11,121,92,0.08) 100%)",
  },
  {
    id: 2,
    title: "Start your",
    ...
    subtitle:
      "Small steps today, giant leaps tomorrow. Begin your Daily SIP and watch your money compound over time.",
  ...
  },
  {
    ...
    subtitle:
      "From a dream home to a world tour, fund your dreams with expert-guided mutual funds and goal planning.",
  ...
  },
  {
    ...
    highlight: "Made Easy",
    subtitle:
      "Invest in ELSS funds and save up to Rs. 46,800 under Section 80C while growing your capital.",
  ...
  },
  {
    ...
    subtitle:
      "Secure your golden years without stress. Build a massive corpus with disciplined, long-term investments.",
    ...
    >
      ...
      <div className="z-[2] mx-auto flex h-full w-full max-w-7xl flex-col items-center justify-between px-6 py-10 md:flex-row md:px-16 md:py-0">
        <div className="flex w-full flex-col items-center text-center md:w-1/2 md:items-start md:text-left">
          <span
            className="inline-flex rounded-full border px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em]"
            style={{
              color: slide.accent,
...
export default function HeroCarousel() {
  ...
  return (
    <>
      ...
      <div className="relative w-full overflow-hidden" style={{ paddingTop: "76px" }}>
        <div
