        ...
        <div className="flex items-center gap-3">
          <div className="hidden items-center gap-3 lg:ml-8 lg:flex">
            ...
            <div className="group relative">
              ...
              <div className="invisible absolute right-0 top-full z-[60] mt-4 hidden w-[500px] translate-y-2 gap-8 rounded-2xl border border-slate-200 bg-white p-6 opacity-0 shadow-[0_18px_40px_-15px_rgba(14,23,40,0.2)] transition-all duration-300 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100 lg:flex">
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-4">
                    <li><Link href="/explore-mutual-funds" className="block text-sm font-semibold text-[#1a1560] transition-colors hover:text-[#04b488]">Large Cap Funds</Link></li>
                    <li><Link href="/explore-mutual-funds" className="block text-sm font-semibold text-[#1a1560] transition-colors hover:text-[#04b488]">Mid Cap Funds</Link></li>
                    <li><Link href="/explore-mutual-funds" className="block text-sm font-semibold text-[#1a1560] transition-colors hover:text-[#04b488]">Small Cap Funds</Link></li>
                  </ul>
                </div>
                ...
                <div className="flex-1 border-l border-slate-100 pl-8">
                  ...
                  <ul className="space-y-4">
                    <li><Link href="/explore-mutual-funds" className="block text-sm font-semibold text-[#1a1560] transition-colors hover:text-[#7B4FD4]">Tax Saver (ELSS)</Link></li>
                    <li><Link href="/explore-mutual-funds" className="block text-sm font-semibold text-[#1a1560] transition-colors hover:text-[#7B4FD4]">Index Funds</Link></li>
                    <li><Link href="/explore-mutual-funds" className="block text-sm font-semibold text-[#1a1560] transition-colors hover:text-[#7B4FD4]">Debt Funds</Link></li>
                  </ul>
                </div>
              </div>
            </div>
