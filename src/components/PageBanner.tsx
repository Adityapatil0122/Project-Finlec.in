    ...
    <section className="relative overflow-hidden px-4 pb-16 pt-14 sm:px-6 sm:pt-16 lg:px-8">
      ...
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[32px] border border-white/75 bg-white/82 p-7 shadow-[0_28px_70px_-42px_rgba(14,23,40,0.42)] backdrop-blur-xl sm:p-9">
        ...
        <div className="relative mt-7 flex flex-wrap gap-3">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-2xl border border-[#7B4FD4]/25 bg-white/70 px-6 py-3 text-sm font-semibold text-[#5e36b3] transition-colors hover:bg-[#7B4FD4]/10"
          >
            Back to Home
          </Link>
        </div>
