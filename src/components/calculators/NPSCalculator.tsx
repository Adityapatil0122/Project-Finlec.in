      ...
      <div className="flex flex-col gap-10 rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:border-white/10 dark:bg-slate-950/60 sm:p-10">
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            <label className="text-sm font-semibold text-[#4a5568] dark:text-slate-300">Investment per month</label>
            <div className="flex items-center gap-1 rounded-xl bg-[#f8f9fa] px-4 py-2 text-[#a855f7] font-bold dark:bg-slate-900 border border-slate-200 dark:border-white/10">
          ...
          <input
            ...
            value={monthlyInvestment}
            onChange={(e) => setMonthlyInvestment(Number(e.target.value))}
            className="h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-[#a855f7] dark:bg-slate-800"
          />
        </div>
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            <label className="text-sm font-semibold text-[#4a5568] dark:text-slate-300">Expected return (p.a)</label>
            <div className="flex items-center gap-1 rounded-xl bg-[#f8f9fa] px-4 py-2 text-[#a855f7] font-bold dark:bg-slate-900 border border-slate-200 dark:border-white/10">
              <input 
                 type="number" 
      ...
      <div className="flex flex-col rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:border-white/10 dark:bg-slate-950/60 sm:p-10 justify-center">
         ...
         <div className="mt-10 space-y-5">
            ...
            <div className="pt-5 mt-2 border-t border-slate-200 dark:border-white/10 flex items-center justify-between">
               <p className="text-base font-semibold text-[#4a5568] dark:text-slate-300">Total Corpus (at age 60)</p>
