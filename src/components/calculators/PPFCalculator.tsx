      ...
      <div className="flex flex-col gap-10 rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:p-10">
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            <label className="text-sm font-semibold text-[#4a5568]">Yearly Investment</label>
            <div className="flex items-center gap-1 rounded-xl bg-[#f8f9fa] px-4 py-2 text-[#eab308] font-bold border border-slate-200">
          ...
          <input
            ...
            value={yearlyInvestment}
            onChange={(e) => setYearlyInvestment(Number(e.target.value))}
            className="h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-[#eab308]"
          />
          <p className="mt-2 text-xs text-slate-500">Maximum limit under Section 80C is ₹1.5 lakh</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-[#eab308]"
          />
          <p className="mt-2 text-xs text-slate-500">PPF has a minimum lock-in of 15 years</p>
        </div>
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 rounded-xl bg-[#f8f9fa] px-4 py-2 text-[#eab308] font-bold border border-slate-200 opacity-75">
              <span>7.1</span>
              <span className="text-sm">%</span>
            </div>
          </div>
          <p className="mt-1 text-xs text-slate-500">Fixed by govt. each quarter.</p>
        </div>
      </div>
