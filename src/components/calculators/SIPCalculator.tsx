...
const DARK_COLORS = ["#1e293b", "#04b488"];
      ...
      <div className="flex flex-col gap-10 rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:border-white/10 dark:bg-slate-950/60 sm:p-10">
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 rounded-xl bg-[#f8f9fa] px-4 py-2 text-[#04b488] font-bold dark:bg-slate-900 border border-slate-200 dark:border-white/10">
          ...
          <input
            ...
            value={monthlyInvestment}
            onChange={(e) => setMonthlyInvestment(Number(e.target.value))}
            className="h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-[#04b488] dark:bg-slate-800"
          />
        </div>
