  ...
  const onboarding: OnboardingTask[] = [
    {
      ...
      description: "Validated KYC is required for full investment access and distributor routing.",
    ...
    },
    {
      ...
      description: "Confirm payout and mandate settlement bank before transactions go live.",
      href: "/dashboard/profile",
      status: "completed",
    },
    {
      ...
      description: "UPI AutoPay or eNACH mandate required for recurring SIPs.",
      href: "/dashboard/sips",
    ...
    },
    {
      ...
      description: "Capture nominee or exemption declaration before scale-up servicing.",
      href: "/dashboard/profile",
    ...
    },
    {
      ...
      description: "Track cut-off eligibility, payment status, and allotment in one flow.",
  ...
  const supportTickets: SupportTicket[] = [
    {
      ...
      type: "KYC",
      status: "IN_PROGRESS",
      subject: "Need validated KYC for fresh purchases",
      description: "Please review my KYC remediation checklist and confirm next steps.",
...
export function updateInvestorProfile(
  ...
  state.auditTrail.unshift({
    ...
    entityType: "InvestorProfile",
    entityLabel: "PAN and FATCA refresh",
